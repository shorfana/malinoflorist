          ...
          <div class="container">
            <div class="row mt-20 mb-45">
              <div class="col-md-6 col-sm-6">
                <div class="img-left"><img src="<?php echo base_url() ?>assets-front/images/demo/about-us-2.jpg" alt="about-us"/></div>
              </div>
              <div class="col-md-6 col-sm-6">
                <div class="who-we-are-right">
                  <h2 class="mt-20 mb-20">Who We Are?</h2>
                  <p class="mb-20">Lorem ipsum dolor sit amet, id velit vivamus donec vitae nulla sem, tincidunt adipis cingac amet vestibulum pede vestibulum, tincidunt convallis at tellus cras sagittis orci, sem iaculis nibh nunc ac. Eros donec vivamus dictum ultricies, turpis sapen fauci bus, duis nulla. Dui vehicula morbi lacus et lobortis.</p>
                  <p class="mb-20">Morbi eros habitant wisi nibh, donec congue quam aenean. Nulla nam quis egestas urna id, hendrerit phasellus ac quis lacus nunc, venenatis vitae sapien diam, justoer los. Nisl vivamus morbi nulla potenti amet ultrices.</p>
                  <div class="sing-bottom text-right">
                    <figure><img src="<?php echo base_url() ?>assets-front/images/demo/sign.png" alt="about-us"/></figure>
                    <p class="blod color-80808">Arthur Miller - CEO</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="sep-ab-pg text-center mb-45"><img src="<?php echo base_url() ?>assets-front/images/demo/sep-ab-pg.png" alt="sep-ab-pg"/></div>
          </div>
        </div>
        ...
        <div class="div-box">
          <div class="slider-instagram">
            <div data-number="8" data-margin="0" data-loop="no" data-navcontrol="yes" class="begreen-owl-carousel">
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-1.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-2.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-3.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-4.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-5.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-6.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-7.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-8.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-6.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-7.jpg" alt="instagram"/></a></div>
              <div><a href="#"><img src="<?php echo base_url() ?>assets-front/images/demo/instagram-8.jpg" alt="instagram"/></a></div>
            </div>
